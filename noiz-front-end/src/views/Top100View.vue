    ...
    <div>
        ...
        <div id="image-header">
            <div class="header-title">
                <svg width="625" height="140" viewBox="0 0 625 166">
                    <defs>
        ...
        <!-- Content -->
        <template v-if="getTop100">
            <section class="main-content">
                <section class="p-8" v-for="(playlist, index) in getTop100" :key="index">
                    <template v-if="playlist.title">
                        <div class="flex items-center mb-4">
                            <vue-feather type="music" size="18" />
                            <p class="font-bold text-md ml-2 extra:text-lg">{{ playlist.title }}</p>
                        </div>
...
#image-header {
    ...
    overflow: hidden;
    position: fixed;
    background: url("@/assets/images/gradient-background.jpg");
